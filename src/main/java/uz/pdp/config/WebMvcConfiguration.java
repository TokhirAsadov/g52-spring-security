...
public class WebMvcConfiguration implements WebMvcConfigurer {
    ...
    public SpringResourceTemplateResolver templateResolver() {
        ...
        templateResolver.setCacheable(true); // Disable caching for development
    ...
    public DriverManagerDataSource dataSource(){
        ...
        dataSource.setDriverClassName(env.getRequiredProperty("spring.datasource.jdbc.driver-class-name"));
